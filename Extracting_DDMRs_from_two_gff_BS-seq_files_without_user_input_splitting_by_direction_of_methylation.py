...
# To use: program_path input_file_1.gff input_file_2.gff percentage_cutoff 
# E.g.: /Users/paulina/MY_STUFF/PhD_project/Applications/My_scripts/Extracting_DDMRs_from_two_gff_BS-seq_files.py /Users/paulina/MY_STUFF/PhD_project/Lister_Pelizzola_BS-seq_data/methylcytosines_h1_all_non-CpG_lines.gff /Users/paulina/MY_STUFF/PhD_project/Lister_Pelizzola_BS-seq_data/methylcytosines_imr90_all_non-CpG_lines.gff 50
...
# Calculate and save as a variable the % difference in region means
        ...
        region_means_difference = ((file_one_region_mean_score - file_two_region_mean_score) * 100)
...
# append to a dictionary called DDMRs wth region id as the key and % difference as the value
        ...
        if region_means_difference >= int(sys.argv[3]):
            DDMRs_h1_more[region] = region_means_difference

        if region_means_difference * int(-1) >= int(sys.argv[3]):
...
h1_more_OutFileName = sys.argv[1] + '_DDMRs_above_' + sys.argv[3] + '%_' + '.gff'
...
imr90_more_OutFileName = '/Users/Paulina/Desktop/test/' + str(context) + "_" + str(chromosome) + '_imr90_more_DDMRs_above_' + sys.argv[3] + '%_' + '.gff'
