...
# This program takes a number of DMR files, intersects them with a 2kb-extended TSS file and extracts genes from them.

# Author: Paulina Chilarska

# First working version saved on: 19/10/2011
...
def TSS_intersection(file):
    outfile = file + "_intersected_with_2kb-extended_TSSs.gff"
    out_file_handle = open(outfile, 'w');
    p = subprocess.Popen(['java', '-Xmx1800M', 'gfftools.RetainOverlapping', file, '/Users/paulina/Desktop/MY_STUFF/PhD_project/Lister_Pelizzola_BS-seq_data/ncbi36-tss_extended_2000bp.gff'],
...
for file_name in list_of_file_names:
    ...
    extract_genes(file_name + "_intersected_with_2kb-extended_TSSs.gff")
