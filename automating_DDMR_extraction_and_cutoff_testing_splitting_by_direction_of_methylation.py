...
#  E.g.:
# /Users/Paulina/MY_STUFF/PhD_project/Applications/My_scripts/automating_DDMR_extraction_and_cutoff_testing_splitting_by_direction_of_methylation.py /Users/Paulina/MY_STUFF/PhD_project/Lister_Pelizzola_BS-seq_data_by_meth_direction/
...
# Set z to 5 and increment by 5 every iteration (this is your cutoff testing)
    ...
    while y < 24:
        ...
        while z <= 95:
            ...
            p = subprocess.Popen(['/Users/Paulina/MY_STUFF/PhD_project/Applications/My_scripts/NEW_DMR_caller_splitting_by_the_direction_of_methylation.py', str(h1_file_path), str(imr90_file_path), str(z)], shell=False)
            p.wait()
            z = z + 5
