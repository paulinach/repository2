...
# Last working version saved on: 27/06/2011
...
h1_more_OutFileName = str(context) + "_" + str(chromosome) + '_h1_more_DDMRs_above_' + sys.argv[3] + '%_' + '.gff'
...
imr90_more_OutFileName = str(context) + "_" + str(chromosome) + '_imr90_more_DDMRs_above_' + sys.argv[3] + '%_' + '.gff'
